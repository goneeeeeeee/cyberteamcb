      ...
      >
        ...
        <div className="lg:basis-1/2 lg:flex lg:flex-col lg:justify-center lg:self-center lg:max-w-[536px]">
          ...
          <p className="indent-3">
            ...
            aliquam facilis officiis, quo non itaque nisi, a reprehenderit
            similique aut doloremque, nemo expedita. Mollitia perspiciatis
            obcaecati similique nemo eligendi consequatur.
          </p>
          <p className="indent-3">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum
            aliquam facilis officiis, quo non itaque nisi
          </p>
        </div>
      </section>
